...
INSERT INTO public.products (name, price, image_url, available, stock) VALUES
  ('Classic Soya', 20, NULL, true, 100),
  ('Mango Soya', 25, NULL, true, 100),
  ('Choco Soya', 25, NULL, true, 100),
  ('Strawberry Soya', 25, NULL, true, 100),
  ('Ube Soya', 25, NULL, true, 100),
  ('Coffee Soya', 25, NULL, true, 100),
  ('Banana Soya', 25, NULL, true, 100)
